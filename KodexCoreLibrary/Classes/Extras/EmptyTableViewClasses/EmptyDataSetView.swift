...
public class EmptyDataSetView: UIView {
    ...
    internal lazy var button: UIButton = {
        ...
        button.backgroundColor = UIColor.init(named: "DividerColor")
        button.borderWidth = 0
        button.borderColor = UIColor.init(hexColor: "7C7B7B")
        button.cornerRadius = 10
        button.setTitleColor(UIColor.init(hexColor: "7C7B7B"), for: .normal)
...
//            contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[customView]|", options: [], metrics: nil, views: ["customView": customView]))
            ...
            if (canShowButton) {
                ...
                contentView.addConstraints([NSLayoutConstraint(item: button, attribute: .centerX, relatedBy: .equal, toItem: contentView, attribute: .centerX, multiplier: 1, constant: 0), NSLayoutConstraint(item: button, attribute: .width, relatedBy: .equal,
